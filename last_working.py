...
pola = unpacksamps(threaddata[1,:], header['nbits'], header['dtype'])
print('VDIF opened.')
...
plt.figure(figsize=(10, 6))
plt.imshow(10 * np.log10(spectrogram + 1e-12), aspect='auto', origin='lower', vmin=-25, vmax=0)
plt.title("Spectrogram")
plt.xlabel("CPI Index")
plt.ylabel("Doppler Bin")
plt.colorbar(label='Power (dB)')
plt.tight_layout()
plt.savefig('./spectrogram_atlas_1.png')
